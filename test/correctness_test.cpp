...
void test_2(vector<std::vector<double>> (*matrix_mult)(const vector<std::vector<double>>&, const vector<std::vector<double>>&)) {
    ...
    vector<vector<double>> A = read_matrix_from_csv("./test/test_case/matrix_A_3x4.csv");
    vector<vector<double>> B = read_matrix_from_csv("./test/test_case/matrix_B_4x2.csv");
    vector<vector<double>> expected = read_matrix_from_csv("./test/test_case/correctness_2.csv");
    try
    {
...
void test_3(vector<std::vector<double>> (*matrix_mult)(const vector<std::vector<double>>&, const vector<std::vector<double>>&)) {
    //3B 
    vector<vector<double>> A = read_matrix_from_csv("./test/test_case/matrix_A_256x256.csv");
    vector<vector<double>> B = read_matrix_from_csv("./test/test_case/matrix_B_256x256.csv");
    vector<vector<double>> C = read_matrix_from_csv("./test/test_case/matrix_C_256x256.csv");
    try
    {
        vector<vector<double>> AB = matrix_mult(A, B);
    ...
    //3E 
    vector<vector<double>> I = read_matrix_from_csv("./test/test_case/identity_matrix_256x256.csv");
    ...
    //3F 
    vector<vector<double>> zero = read_matrix_from_csv("./test/test_case/zero_matrix_256x256.csv");
